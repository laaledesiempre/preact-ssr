...
Object.defineProperty(exports, "EditPost", {
    enumerable: true,
    get: function() {
        return EditPost;
    }
...
var _reloadPosts = require("../utils/reloadPosts");
...
var EditPost = function(props) {
    ...
    var handleSubmit = function(e) {
        e.preventDefault();
        var _e_target_editDialogContent = e.target.editDialogContent, content = _e_target_editDialogContent.value;
        _axios.default.put("./db/change/post/" + props.id, {
            content: content
        }, {
            headers: {
    ...
    return /*#__PURE__*/ (0, _preact.h)(_preact.Fragment, null, /*#__PURE__*/ (0, _preact.h)("dialog", {
        ...
        type: "submit"
    }, "Edit!")), /*#__PURE__*/ (0, _preact.h)("button", {
        onClick: function(e) {
            return document.querySelector("#edit-dialog" + props.id).close();
        }
    }, " x ")), /*#__PURE__*/ (0, _preact.h)("button", {
        class: "edit-button",
        onClick: function(e) {
            return document.querySelector("#edit-dialog" + props.id).showModal();
        }
    }, /*#__PURE__*/ (0, _preact.h)(_icons.Pencil, null)));
};
